...
<templates:paginaReportes
	nombreFuncionalidad="Reporte Productos Inactivos">

	<jsp:attribute name="panelPrincipal">
		<div style="margin: 8px; border: 1px solid #CCC">
			<object data="productosInactivos.jsp?pdf=1#toolbar=1" type="application/pdf"
				width="100%" height="500px">
				
				<a href="productosInactivos.jsp?pdf=1">Descargar reporte</a>
			</object>

...
<templates:paginaReportes
	nombreFuncionalidad="Reporte Productos Bajo el Stock Mínimo">

	<jsp:attribute name="panelPrincipal">
		<div style="margin: 8px; border: 1px solid #CCC">
			<object data="reporteBajoStock.jsp?pdf=1#toolbar=1" type="application/pdf"
				width="100%" height="500px">
				
				<a href="reporteBajoStock.jsp?pdf=1">Descargar reporte</a>
			</object>

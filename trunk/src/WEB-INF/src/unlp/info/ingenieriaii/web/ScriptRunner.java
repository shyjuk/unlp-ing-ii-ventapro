		...
		try {
			...
			while ((line = lineReader.readLine()) != null) {
				...
				if (trimmedLine.startsWith("--")) {
					...
					{ // Los autores de esto no tuvieron en cuenta comandos que
						// terminen en comentarios...
			...
			// conn.rollback(); // Esta linea está mal, causa error siempre y es
			// ridiculo porque estaría volviendo para atrás tanto si hubo error
			// como si no. No entiendo como nadie dice nada :S
			flush();
		}
	}
